...
import { GlobalProvider } from './productTypeContext';
            ...
            <div className='overflow-x-auto border rounded-lg' >
              <div className='flex justify-between items-center p-4'>
                <div className='flex flex-col'>
                  ...
                  <p className='hidden md:block text-sm text-gray-500'>A list of all the product types in your account</p>
                </div>
                <Link href='productTypes/create'
                  className='p-2 px-4 bg-primaryColor text-white rounded-lg text-xs md:text-sm text-center'
                >Add product type</Link>
              </div>
              <div ref={contentRef}>
